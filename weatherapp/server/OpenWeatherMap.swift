...
extension OpenWeatherMap: TargetType {
    ...
    public var task: Task {
        ...
        case .weather(let city):
            return .requestParameters(parameters: ["id": city, "units": "metric"], encoding: URLEncoding.default)
        }
    }
